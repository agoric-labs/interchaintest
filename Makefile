...
interchaintest: gen ## Build interchaintest binary into ./bin
	go test -ldflags "-X github.com/agoric-labs/interchaintest/v6/internal/version.GitSha=$(shell git describe --always --dirty)" -c -o ./bin/interchaintest ./cmd/interchaintest
